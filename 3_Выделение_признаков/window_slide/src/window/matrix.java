...
public class matrix {
    ...
    public String Matrix (String str) throws java.lang.Exception {
        ...
        FileInputStream f = new FileInputStream("C:/Users/user/Desktop/Telegram Desktop/window_slide/csv_templates.csv");
        BufferedReader br = new BufferedReader(new InputStreamReader(f));

        FileWriter ffw = new FileWriter(new File("matrix.csv"), true);
        PrintWriter pw2 = new PrintWriter(ffw);

        int l = countLines("C:/Users/user/Desktop/Telegram Desktop/window_slide/csv_templates.csv");
